...
if (isset($_GET['BARCODE'])) {
    ...
    /* Check if barcode exist if true create a jeso with the product informations else if URL contain all the
    parameters insert the new prosuct to the remoteDB else do nothing */
